        ...
        <div className="card-body">
          <div className="row">
            ...
            <div className={`${loading ? 'd-none' : 'col-12 offset-md-1 col-md-10 p-0'}`}>
              {
                teacherInfo && (
                  <div className={`${teacherInfo ? 'row' : 'd-none'}`} data-test="teacherInfo">
              ...
              <div className="table-responsive">
                {
                  appointments.length > 0 ? (
                    <>
                      <table className="table table-sm table-hover w-100" data-test="teacherIncomingAppointments">
                        <thead>
                          <tr>
                      ...
                      <table className="table table-sm table-hover w-100 mt-3" data-test="teacherPastAppointments">
                        <thead>
                          <tr>
